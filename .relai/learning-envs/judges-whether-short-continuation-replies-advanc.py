...
environment = RELAIEnvironment(
    ...
    id="judges-whether-short-continuation-replies-advanc",
    name="Brief Replies Continue Lessons",
    description="Checks that brief replies like yes or next move an in-progress lesson forward instead of stalling.",
    tags=TAGS,
    input=FixedInput(
        turns=[
            FixedTurn(
                content=(
                    "/lesson Start my next lesson and teach me one small step at a time."
                )
            ),
