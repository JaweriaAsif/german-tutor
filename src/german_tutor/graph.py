...
SPECIALIST_PROMPTS: dict[str, str] = {
    ...
    "lesson": (
        ...
        "success_feedback, advancement_note, practice metadata, and "
        ...
        "example with an English gloss on the same turn, (3) a small visible "
        ...
        "wrong or partial answer, use the stored correction guidance to name the "
        "specific fix, show the corrected German, and briefly explain what to "
        "notice. If the learner answers correctly, use the stored success_feedback "
        "cue to give response-specific praise tied to the exact German they used. "
